    ...
    >
      <Container maxWidth="md">
        ...
        >
          ...
          >
            <CardContent sx={{ p: 4 }}>
              ...
              <Typography variant="h4" fontWeight={800} color="white" sx={{ mt: 1, mb: 0.5 }}>
                $0
              </Typography>
              ...
              <Button
                ...
                variant="outlined"
                disabled
                sx={{ mt: 3, borderColor: 'rgba(255,255,255,0.2)', color: 'grey.500' }}
              >
                Current Plan
              </Button>
            </CardContent>
              ...
              <List dense disablePadding>
                {PRO_FEATURES.map((f) => (
                  <ListItem key={f} disablePadding sx={{ mb: 1 }}>
                    ...
                    <ListItemText
                      primary={f}
                      primaryTypographyProps={{ color: 'white', fontSize: 14, fontWeight: f.includes('Everything') ? 600 : 400 }}
                    />
                  </ListItem>
                ))}
              </List>
              ...
              {loading ? (
                ...
                <Box sx={{ mt: 3 }}>
                  ...
                  {stripeCustomerId && (
                    ...
                    >
                      {portalLoading ? <CircularProgress size={16} /> : 'Manage Billing'}
                    </Button>
                  )}
                </Box>
              ) : (
        ...
        >
          ...
          <Typography variant="body2" color="grey.500">
            Features marked with a lock icon in the app require a Pro subscription. Your data is always yours — even if you cancel.
          </Typography>
        </Box>
      </Container>
    </Box>
