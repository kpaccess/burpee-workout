        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              ...
              <TableCell sx={{ fontWeight: 700, color: "text.secondary" }}>Tier</TableCell>
              <TableCell sx={{ fontWeight: 700, color: "text.secondary" }}>Level</TableCell>
              <TableCell sx={{ fontWeight: 700, color: "text.secondary" }}>Onboarded</TableCell>
              <TableCell sx={{ fontWeight: 700, color: "text.secondary" }}>Pro</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
