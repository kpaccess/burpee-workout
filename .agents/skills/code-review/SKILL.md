...
Ask Codex to review code in one of these ways:
...
To enable automatic code review on file save, before commit, or before push, hooks must be configured in your Codex settings. This requires your Codex administrator to add the appropriate hooks. Contact support or refer to the settings documentation.
...
2. **Include context**: Tell Codex what the change is trying to accomplish
